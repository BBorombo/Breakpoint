...
class DataService{
    ...
    func getAllFeedMessages(handler: @escaping (_ messages: [Message]) -> ()){
        ...
        REF_FEED.observeSingleEvent(of: .value) { (feddMessageSnapshot) in
            guard let feddMessageSnapshot = feddMessageSnapshot.children.allObjects as? [DataSnapshot] else {return}
            
            for message in feddMessageSnapshot {
    ...
    func getAllMessagesFor(desiredGroup group:Group, handler: @escaping (_ messages: [Message]) -> ()){
        var messageArray = [Message]()
    ...
    func getAllGroups(handler: @escaping (_ groupeArray: [Group]) -> ()){
